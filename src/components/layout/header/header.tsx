    ...
    return (
        <header className="header container">
            ...
            <div className="header__menu">
                ...
                <NavLink to="/contact" className="header__menu_link">CONTACT</NavLink>
            </div>
            <button className="burger_menu" onClick={() => {setIsActive(isActive => !isActive)}}>
                <svg className={`ham ${isActive ? `active` : ''}`} viewBox="0 0 100 100">
            ...
            {isActive && <div onClick={() => setIsActive(false)} className="active_background" />}
        </header>
    );
}